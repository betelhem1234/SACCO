...
export const searchMembers = createAction('[MEMBER] Search Members', props<{
  pageSize: number;
  pageIndex: number;
  sortField: string;
...
export const searchMembersSuccess = createAction('[MEMBER] Search Members Success', props<{ data: Member[]; total: number }>());
export const searchMembersFailure = createAction('[MEMBER] Search Members Failure', props<{ error: any }>());
